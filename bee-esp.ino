#define BLYNK_TEMPLATE_ID "TMPL6Br9XbE2_"
#define BLYNK_TEMPLATE_NAME "sau"
...
BLYNK_WRITE(V5) {               // Virtual Pin V5 is assigned to input number widget
  mosfetSpeed = param.asInt();  // Set the temperature range from the app
  sendToArduino();
}

BLYNK_WRITE(V4) {                  // Virtual Pin V4 is assigned to button widget
...
BLYNK_WRITE(V6) {               // Virtual Pin V6 controls Relay 1
  relayState1 = param.asInt();  // Update the state of relay 1
  sendToArduino();
}

BLYNK_WRITE(V7) {               // Virtual Pin V7 controls Relay 2
  relayState2 = param.asInt();  // Update the state of relay 2
  sendToArduino();
}

BLYNK_WRITE(V8) {               // Virtual Pin V8 controls Relay 3
  relayState3 = param.asInt();  // Update the state of relay 3
  sendToArduino();
}

BLYNK_WRITE(V9) {               // Virtual Pin V9 controls Relay 4
